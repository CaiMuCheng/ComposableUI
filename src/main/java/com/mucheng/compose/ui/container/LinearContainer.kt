...
@Inline
inline fun ComposeScope.Linear(
    controller: Controller = Controller,
    orientation: LinearOrientation = LinearOrientation.HORIZONTAL,
    onReceive: LinearLayoutCompat.() -> Unit = {},
    onLayout: LinearContainerScope.() -> Unit
) {
    with(LinearLayoutCompat(Store.activity)) {
        ...
        val scope = LinearContainerScope(this)
        scope.onLayout()
    }
}

@Inline
inline fun ComposeScope.Column(
    controller: Controller = Controller,
    onReceive: LinearLayoutCompat.() -> Unit = {},
    onLayout: LinearContainerScope.() -> Unit
) {
    Linear(controller, LinearOrientation.VERTICAL, onReceive, onLayout)
}

@Inline
inline fun ComposeScope.Row(
    controller: Controller = Controller,
    onReceive: LinearLayoutCompat.() -> Unit = {},
    onLayout: LinearContainerScope.() -> Unit
) {
    Linear(controller, LinearOrientation.HORIZONTAL, onReceive, onLayout)
}

open class LinearContainerScope(Container: LinearLayoutCompat) : ComposeScope(Container) {
