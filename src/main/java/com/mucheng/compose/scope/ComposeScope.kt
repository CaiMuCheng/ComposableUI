...
package com.mucheng.compose.scope
...
open class ComposeScope(val Container: ViewGroup) {
    ...
    private fun applyDimension(unit: Int, value: Float): Float {
        return TypedValue.applyDimension(unit, value, Container.context.resources.displayMetrics)
    }
