...
package com.mucheng.compose.map
...
class ResourcePainter(context: Context, resource: Int) : AbstractPainter(context) {

    private val drawable = ContextCompat.getDrawable(context, resource)!!
